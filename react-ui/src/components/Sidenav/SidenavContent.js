  ...
  render() {
    ...
    return (
      <ul className="nav" ref={(c) => { this.nav = c; }}>
        ...
        <li><FlatButton id="pull-requests" href="#/app/pull-requests"><i className="nav-icon material-icons">face</i><span className="nav-text">Pull Requests</span></FlatButton></li>
        <li><FlatButton id="commits" href="#/app/commits"><i className="nav-icon material-icons">work</i><span className="nav-text">Commits</span></FlatButton></li>
        <li><FlatButton id="reviews" href="#/app/reviews"><i className="nav-icon material-icons">loyalty</i><span className="nav-text">Reviews</span></FlatButton></li>
      </ul>
    );
  }
}
